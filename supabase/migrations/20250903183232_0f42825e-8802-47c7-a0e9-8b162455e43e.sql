-- Implementar sistema completo de prevenção de duplicatas para laboratórios

-- 1. Criar constraint única para laboratórios (evita duplicatas no mesmo dia)
...
-- 4. Função para verificar disponibilidade em tempo real
